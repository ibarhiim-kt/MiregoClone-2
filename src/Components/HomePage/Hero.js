  ...
  return (
    ...
    <div className='pt-[149.5px] px-[140px] font-AlmiregoDisplayLight max-xl:pt-[113.5px] max-xl:px-[72px] max-[1024px]:pt-20 max-[1024px]:flex items-center gap-[13px] max-[1014px]:block max-[1014px]:pt-[92.5px] max-md:flex max-md:gap-[5px] max-md:px-8 max-md:pt-[64px] max-[563px]:block max-[563px]:pt-[70.5px] max-[425px]:pt-12 max-[390px]:px-6 min-[1670px]:flex min-[1670px]:pt-[128px] min-[1670px]:gap-[22px] min-[1921px]:px-[280px] min-[1921px]:block min-[1921px]:pt-[150.5px] min-[1951px]:flex min-[1921px]:pt-[128.5px]'>
      ...
      <div className='flex leading-[1.334]'>
        <div className='py-[2px] text-[90px] px-[33px] border-[4px] border-black rounded-[70px] max-xl:py-[1.5px] max-xl:text-[82px] max-[1024px]:text-[53px] max-[1024px]:px-[18px] max-[1024px]:py-[4px] max-[1024px]:border-[3px] max-md:text-[32px] max-md:px-[12px] max-md:py-[3px] max-md:border-[2px] 
      ...
      <div className="pt-[62px] px-[140px] pb-32 font-AlmiregoDisplayRegular max-xl:pt-[56px] max-xl:px-[72px] max-xl:pb-[96px] max-[1024px]:pt-[48px] max-[1024px]:pb-20 max-md:pt-[30px] max-md:px-8 max-md:pb-16 max-[390px]:px-6 max-[320px]:pt-[15px] max-[320px]:pb-[48px] gsapAnima min-[1921px]:px-[280px] ">
      <p className='text-[56px] leading-[112%] max-xl:text-[52px] max-[1024px]:text-[36px] max-[454px]:text-[28px] max-[320px]:text-[24px] min-[1734px]:w-[1454px] min-[1921px]:w-[100%]'>
