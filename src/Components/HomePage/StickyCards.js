...
const StickyCards = () => {
  ...
  return (   
      ...
      <div className="pt-32 max-xl:pt-24 max-lg:pt-20 max-md:pt-16 max-424:pt-12">
           <h1 className='text-[120px] font-AlmiregoDisplayLight leading-105 max-[1440px]:text-8xl max-lg:text-[68px] max-424:text-[40px] max-320:text-3.5xl'>Made with <span className='font-NewsreaderItalic font-light tracking-[-1.75px]'>passion </span></h1>
