...
export default function Navbar() {
  return (
    <div className='flex justify-between items-center pt-[60px] px-[60px] w-full '>
      <a href="#">
        <img src={logo} alt="logo" />
      </a>
      <div className='text-[15px] flex items-center gap-1 text-[#050307] justify-between w-[51.5%]'>
