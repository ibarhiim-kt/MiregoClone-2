  ...
  return (
    ...
    <div className='flex justify-between items-center pt-[60px] pb-[54px] px-[60px] w-full font-AlmiregoDisplayRegular fixed top-0 z-50 max-[1024px]:p-10 max-[768px]:p-8 max-[424px]:p-6 max-[320px]:p-5 '>
      ...
      bg-[rgba(255,255,255,.5)] rounded-xl backdrop-blur-14 leading-[1.174] max-[1439px]:gap-0 max-[1024px]:hidden' style={{ backdropFilter: 'blur(14px) '}}>        
        <Link to="/about" className='px-[18px] py-[12px] relative group'>About <div className='top-[80%] w-[4px] h-[4px] bg-[black] hidden group-hover:inline rounded-full absolute left-[45%] '></div></Link>
        <Link to="/Expertise" className='px-[18px] py-[12px] group relative'>Expertise <div className='top-[80%] w-[4px] h-[4px] bg-[black] hidden group-hover:inline rounded-full absolute left-[45%]'></div></Link>
        <Link to="/Projects" className='px-[18px] py-[12px] group relative'>Projects <div className='top-[80%] w-[4px] h-[4px] bg-[black] hidden group-hover:inline rounded-full absolute left-[45%]'></div></Link>
        <Link to="/Culture" className='px-[18px] py-[12px] group relative'>Culture <div className='top-[80%] w-[4px] h-[4px] bg-[black] hidden group-hover:inline rounded-full absolute left-[45%]'></div></Link>
        <Link to="Perspectives" className='px-[18px] py-[12px] group relative'>Perspectives <div className='top-[80%] w-[4px] h-[4px] bg-[black] hidden group-hover:inline rounded-full absolute left-[45%]'></div></Link>
      </div>
