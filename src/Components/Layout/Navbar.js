...
export default function Navbar() {
  ...
  return (
    ...
    <div className='flex justify-between items-center pt-[60px] px-[60px] w-full font-AlmiregoDisplayRegular fixed top-0 z-50  max-lg:p-10  max-md:p-8 max-[424px]:p-6 max-[320px]:p-5'>
      ...
      bg-[rgba(255,255,255,.5)] rounded-xl backdrop-blur-14 leading-[1.174] max-[1439px]:gap-0  max-lg:hidden min-[1729px]:text-[17px] blackNavbarAnima' style={{ backdropFilter: 'blur(14px)'}}>   
      {links.map((map,index)=>(  
      ...
      <button className='px-[18px] py-[10px] border rounded-[20px] border-[#050307]  bg-[rgba(255,255,255,.5)] hidden  max-lg:inline  max-md:px-[12px] max-[320px]:text-[14px] blackNavbarAnima' style={{ backdropFilter: 'blur(14px)', transition: 'transform 0.3s ease' }}>Menu</button>
</div>
</div>
</header>
  )
