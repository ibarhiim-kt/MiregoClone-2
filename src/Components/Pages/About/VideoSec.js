...
export default function VideoSec() {
  return (
    <div>
      <div className='py-16 px-10 flex justify-between gap-2 max-xl:py-14 max-lg:py-12 max-md:flex-col max-md:px-4  max-md:py-8 max-sm:px-2 max-xxs:py-6 5xl:justify-start min-2xl:gap-[42px] 
       min-5xl:gap-[60px]'>
        ...
        <div className='w-[66%] overflow-hidden max-md:w-full min-xl:w-[43%] min-5xl:w-[32%]'>
